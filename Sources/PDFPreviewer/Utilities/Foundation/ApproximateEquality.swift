...
extension Int {
    ...
    ///
    /// This value is typically used by various methods and functions that search for items in serial data and return indices, such as characters in a string object or `id` objects in an `NSArray` object.
    ///
    /// To support 64-bit environments, this value is now formally defined as `NSIntegerMax`.
    static let notFound = NSNotFound
}
